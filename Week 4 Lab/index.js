...
console.log(`${myName} and ${myFriendsName} are going to eat ${food} with some ${drink}.`);
...
//Answer:
console.log(myFriendsName + " & " + myName + " are going to eat " + food + " & " + drink + ".");
...
//Answer: Uncaught SyntaxError: missing ) after argument list, in my own words i believe this means that the verbage used in the code are incorrect. const cant be change, so i had to go back and change the it to let
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunchTime = (foodChoice , drinkChoice) => `${myName} and ${myFriendsName} are going to eat ${foodChoice} with some ${drinkChoice}.`
...
//  return `${myName} and ${myFriendsName} are going to eat ${foodChoice} with some ${drinkChoice}.`
// }
...
const foodForTodayAndTomorrow = (tomorrowsFoodChoice,tomorrowsDrinkChoice,callbackFunction) => {
    ...
    console.log(foodForTodayAndTomorrow ('Salmon','Orange Juice',lunchTime('rice', 'boba')))
